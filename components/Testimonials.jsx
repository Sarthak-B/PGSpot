  ...
  const testimonials = [
    {
      ...
      text: "PGSpot made finding my room so easy! The verification process was quick and the property owners were very responsive.",
      rating: 5,
      avatar: "👩‍🎓",
    },
    {
    ...
    },
    {
      name: "Anjali Patel",
      college: "BITS Pilani",
      text: "Finally found a hassle-free way to book my accommodation. PGSpot is definitely the best student housing platform.",
      rating: 5,
      avatar: "👩‍🎓",
    },
  ]
